...
CREATE TABLE `section` (
  `course_id` varchar(8) CHARACTER SET utf8 NOT NULL,
  `sec_id` varchar(8) CHARACTER SET utf8 NOT NULL,
  `semester` varchar(6) CHARACTER SET utf8 NOT NULL,
  `year` decimal(4,0) NOT NULL,
  `building` varchar(15) CHARACTER SET utf8 NOT NULL,
  `room_number` varchar(7) CHARACTER SET utf8 NOT NULL,
  `time_slot_id` varchar(4) CHARACTER SET utf8 NOT NULL
